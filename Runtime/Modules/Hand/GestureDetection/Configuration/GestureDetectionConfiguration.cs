...
{
    [CreateAssetMenu(menuName = "HPTK/GestureDetectionConfiguration", order = 2)]
    public class GestureDetectionConfiguration : HPTKConfiguration
    {
        [HideInInspector]
        ...
        [Header("Fist")]
        public float maxPalmRelDistance = 0.09f;
        ...
        public float minTimeToIntention = 0.25f;
